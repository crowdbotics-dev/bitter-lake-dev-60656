"""
Django settings for bitter_lake_dev_60656 project.
...
ROOT_URLCONF = 'bitter_lake_dev_60656.urls'
...
WSGI_APPLICATION = 'bitter_lake_dev_60656.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bitter_lake_dev_60656 API",
    "DESCRIPTION": "API documentation for bitter_lake_dev_60656 App",
    "VERSION": "v1",
}
